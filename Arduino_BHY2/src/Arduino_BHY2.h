...
class NiclaSettings {
public:
  NiclaSettings(uint8_t i2c, uint8_t ble, uint8_t eslov, uint8_t shield) {
    conf = i2c | ble | eslov | shield;
  }
...
private:
  ...
  NiclaSettings _settings = NiclaSettings(NICLA_I2C, NICLA_BLE, NICLA_VIA_ESLOV, 0);
};
