...
void setup()
{
  ...
  BHY2.begin();
  sensortec.bhy2_bsec2_setHP((uint8_t*)BSEC2HP_TEMP, sizeof(BSEC2HP_TEMP), (uint8_t*)BSEC2HP_TIME, sizeof(BSEC2HP_TIME)); 
...
void loop()
{
  ...
  // Serial.println(String("bsec2: ") + bsec2Collector.toString());
