...
if __name__ == '__main__':
    ...
    """
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-00-regular.log", gas_label = 0, timestamp_offset_ms = 0)
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-01-alcohol.log", gas_label = 1, timestamp_offset_ms = 0)
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-03-loctite-super-glue.log", gas_label = 2, timestamp_offset_ms = 0)
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-04-loctite-super-glue-2.log", gas_label = 2, timestamp_offset_ms = 9137261)
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-05-regular-after-loctite-super-glue.log", gas_label = 0, timestamp_offset_ms = 9137261 + 30*60*1000)
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-06-alcohol.log", gas_label = 1, timestamp_offset_ms = 9137261 + 30*60*1000)
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-01-regular_air.log", gas_label = 0, timestamp_offset_ms = 0)
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-02-alcohol_wipe.log", gas_label = 1, timestamp_offset_ms = 0)
    #parser = BSEC2DataLogConverter("./log/training/putty-session7-03-regular_air_office.log", gas_label = 0, timestamp_offset_ms = 7557573)
    #parser = BSEC2DataLogConverter("./datalog/session3-home-room1/putty-session3-00-coffee.log", gas_label = 2, timestamp_offset_ms = 0)
    if (len(sys.argv) < 4):
        print("usage:")
        ...
        print("example:")
        print("\tpython", sys.argv[0], "./datalog/session3-room2/ambient-air.log", "0", "./Nicla_BoardConfiguration.bmeconfig")
